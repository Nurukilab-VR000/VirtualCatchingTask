...
public class Motion_Ball : MonoBehaviour
{
    [SerializeField] Transform endPos;  //終点座標
    [SerializeField] float speedRate;   //滞空時間を基準とした移動速度倍率
    ...
    void Start()
    {
        ...
        //タスクに応じて変更
        //CSVSave(endPos, speedRate, "Predicton_2023xxxx_xxxx");
        CSVSave(endPos, speedRate, "Catching_2023xxxx_xxxx");
