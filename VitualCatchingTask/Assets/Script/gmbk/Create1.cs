...
public class Create1 : MonoBehaviour
{
    ...
    {
        //座標生成
        float x_r = UnityEngine.Random.Range(0.6f, 1.1f);
        float y_r = UnityEngine.Random.Range(1.0f, 1.5f);
        float z_r = UnityEngine.Random.Range(3.0f, 3.5f);

        float x_l = UnityEngine.Random.Range(1.1f, 1.6f);
        float y_l = UnityEngine.Random.Range(1.0f, 1.5f);
        float z_l = UnityEngine.Random.Range(3.0f, 3.5f);
